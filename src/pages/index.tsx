      ...
      <div className="flex h-screen bg-gray-50 items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className='grid grid-cols-3 gap-4'>
            <button
              className="rounded-md border border-current bg-transparent py-2 px-4 text-sm font-medium text-slate-500 hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-700 focus:ring-offset-2"
            >
              Twitter
            </button>
            <button
